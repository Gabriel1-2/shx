...
import { Loader2, Settings, ShieldCheck, X, ArrowUpDown, Clock, BarChart2, Minimize2 } from "lucide-react";
...
export default function CustomSwap({ onToggleChart, onPairChange, isChartOpen = false }: CustomSwapProps) {
    ...
    }, [inputPrice, outputPrice, limitRate]);
    ...
    }, [amount, slippage, tokens, feeBps, activeTab]);
